...
class Master extends EventEmitter {
  ...
  constructor(options) {
    ...
    this.logger.info(`[master] start with env: isProduction: ${this.isProduction}, EGG_SERVER_ENV: ${process.env.EGG_SERVER_ENV}, NODE_ENV: ${process.env.NODE_ENV}, isDebug: ${this.isDebug}`);
