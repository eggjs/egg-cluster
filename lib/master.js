...
const PROTOCAL = Symbol('Master#protocal');
...
class Master extends EventEmitter {
  ...
  constructor(options) {
    ...
    this[PROTOCAL] = this.options.https ? 'https' : 'http';
    ...
    this.on('realport', ({ port, protocal }) => {
      if (port) this[REAL_PORT] = port;
      if (protocal) this[PROTOCAL] = protocal;
    });
...
>>>>>>> refactor: rename REALPORT to REAL_PORT
      return;
    }
    ...
    address.protocal = this[PROTOCAL];
