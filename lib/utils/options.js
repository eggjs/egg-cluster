...
module.exports = function(options) {
  ...
  if (options.https) {
    ...
    assert(httpsOptions.key && fs.existsSync(httpsOptions.key), 'options.httpsOptions.key should exists');
    assert(httpsOptions.cert && fs.existsSync(httpsOptions.cert), 'options.httpsOptions.cert should exists');
  }
